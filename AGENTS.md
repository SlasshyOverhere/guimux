...
- `cd src-tauri && cargo test` — Rust tests (`worktree_lifecycle`, `status_and_diff`, `encoded_command_matches_powershell`, `alias_stub_rejected`). Single test: `cd src-tauri && cargo test <name>`. No frontend tests.
